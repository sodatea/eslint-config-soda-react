module.exports = {
    ...
    rules: {
        ...
        // Enfors indentation style to be 4 spaces
        'react/jsx-indent': ['warn', 4],    // eslint-disable-line no-magic-numbers

        // Enforce props indentation to be 4 spaces
        'react/jsx-indent-props': ['warn', 4],   // eslint-disable-line no-magic-numbers
